...
from .embedders.embedder_v1 import EmbedderV1
...
class GPTModelV1Config(metaclass=SingletonMeta):
    ...
    _gpt_model_v1_embedder: Embedder
    ...
    def initialize(self) -> None:
        self._gpt_model_v1_embedder = EmbedderV1()
    ...
    @property
    def gpt_model_v1_embedder(self):
        return self._gpt_model_v1_embedder
